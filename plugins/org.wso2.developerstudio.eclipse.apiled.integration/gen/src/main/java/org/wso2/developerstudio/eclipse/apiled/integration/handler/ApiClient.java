...
import org.wso2.developerstudio.eclipse.apiled.integration.handler.auth.Authentication;
import org.wso2.developerstudio.eclipse.apiled.integration.handler.auth.HttpBasicAuth;
import org.wso2.developerstudio.eclipse.apiled.integration.handler.auth.ApiKeyAuth;
import org.wso2.developerstudio.eclipse.apiled.integration.handler.auth.OAuth;
import org.wso2.developerstudio.eclipse.apiled.integration.handler.auth.RetryingOAuth;
import org.wso2.developerstudio.eclipse.apiled.integration.handler.auth.OAuthFlow;

public class ApiClient {

    private String basePath = "https://apis.wso2.com/api/am/endpoint-registry/v1";
    ...
    public ApiClient(String clientId, String clientSecret, Map<String, String> parameters) {
        ...
        RetryingOAuth retryingOAuth = new RetryingOAuth("https://example.com/oauth/token", clientId, OAuthFlow.accessCode, clientSecret, parameters);
        authentications.put(
                "OAuth2",
                retryingOAuth
        );
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://apis.wso2.com/api/am/endpoint-registry/v1
